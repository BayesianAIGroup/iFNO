...
parser.add_argument("--lr-forward", type=float, help="learning rate for joint Training-forward", default=0.0001)
parser.add_argument("--lr-backward", type=float, help="learning rate for joint Training-backward", default=0.0001)
...
y_no_noise = np.load("./data/wave_oval_u.npy")[:, ::10, ::2]
x_no_noise = np.load("./data/wave_oval_k.npy")[:, ::2, ::2]

print(x_no_noise.shape, y_no_noise.shape, x_no_noise.min(), x_no_noise.max())
if args.nl == 0.0:
    y = np.load("./data/wave_oval_u.npy")[:, ::10, ::2]
    x = np.load("./data/wave_oval_k.npy")[:, ::2, ::2]
    extra_f = np.load("./data/wave_oval_k.npy")[:ntrain, ::2, ::2]
elif args.nl == 0.1:
    y = np.load("./data/wave_oval_u_01.npy")[:, ::10, ::2]
    x = np.load("./data/wave_oval_k_01.npy")[:, ::2, ::2]
    extra_f = np.load("./data/wave_oval_k_01.npy")[:ntrain, ::2, ::2]
elif args.nl == 0.2:
    y = np.load("./data/wave_oval_u_02.npy")[:, ::10, ::2]
    x = np.load("./data/wave_oval_k_02.npy")[:, ::2, ::2]
    extra_f = np.load("./data/wave_oval_k_02.npy")[:ntrain, ::2, ::2]
